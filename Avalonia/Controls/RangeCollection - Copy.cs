...
namespace Avalonia.Controls
{
    ...
    internal class RangeCollection : ICloneable, ICollection<int>
    {
        ...
        private void EnsureCapacity(int growBy)
        {
            ...
            int min_capacity = this.ranges.Length == 0 ? MIN_CAPACITY : this.ranges.Length + growBy;
        ...
        public Range[] Ranges
        {
            get
            {
                Range[] ranges_copy = new Range[this.rangeCount];
                Array.Copy(this.ranges, ranges_copy, this.rangeCount);
                return ranges_copy;
            }
        }
        ...
        public void Clear()
        {
            ...
            this.indexCount = 0;
            this.generation++;
            this.ranges = new Range[MIN_CAPACITY];
        }
